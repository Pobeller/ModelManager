        ...
        Dictionary<string, object> parameters)
        {
            ...
            using (_currentProcess = new Process { StartInfo = psi })
            {
                try
                {
                    ...
                    _currentProcess.OutputDataReceived += (s, e) => AppendDebugText(e.Data);
        ...
        public class ModelParameterService
        {
            ...
            private async Task<ModelType> DetermineModelTypeAsync(string modelName)
            {
                ...
                try
                {
                    ...
                    {
                        var t when t.Contains("diffusers") => ModelType.TextToImage,
                        var t when t.Contains("text-to-speech") => ModelType.TextToSpeech,
                        var t when t.Contains("animation") => ModelType.TextToVideo,
                        _ => ModelType.Unknown
                    };
